...
{
    public partial class Administrator23 : Form
    {
        public Administrator23()
        {
            InitializeComponent();
        }

        private void Administrator23_Load(object sender, EventArgs e)
        {
            Table();
        ...
        public void Table()//从数据库读取数据显示在表格控件中
        {
            ...
            Dao dao = new Dao();
            string sql = "select SNO,SNAME from STAFF";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please select the staff to be deleted in the form first!", "Tips", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void button2_Click_1(object sender, EventArgs e)
        {
            ...
            string sql = $"update STAFF set SPASS = '{ID}' where SNO = '{ID}'";
            Dao dao = new Dao();
            if (dao.Execute(sql) > 0)
            {
                MessageBox.Show("Success!");
